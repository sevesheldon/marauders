...
<html <?php language_attributes(); ?> class="no-js">
	<head>
        ...
        <link href="<?php echo get_template_directory_uri(); ?>/img/icons/drum_favicon.png" rel="shortcut icon">
			...
			<header class="header clear" role="banner">
					...
					<div class="logo">
						<a href="<?php echo home_url(); ?>">
							...
							<img src="<?php echo get_template_directory_uri(); ?>/img/marauders_transp.png" alt="Logo" class="logo-img">
						</a>
					</div>
					<!-- /logo -->
